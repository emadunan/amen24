...
export class Init1739558573385 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."verse_language_enum" AS ENUM('na', 'en', 'ar', 'he', 'fr', 'de', 'es', 'it', 'pt', 'ru', 'zh', 'ja', 'ko', 'tr', 'fa', 'ur', 'hi', 'bn', 'id', 'ms', 'th', 'nl', 'sv', 'no', 'da', 'fi', 'pl', 'cs', 'hu', 'ro', 'el', 'uk', 'vi', 'sr', 'hr', 'bg', 'sk', 'sl', 'lt', 'lv', 'et', 'tl', 'sw')`,
    );
    await queryRunner.query(
