...
export class Init1739558573385 implements MigrationInterface {
    name = 'Init1739558573385'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."verse_language_enum" AS ENUM('na', 'en', 'ar', 'he', 'fr', 'de', 'es', 'it', 'pt', 'ru', 'zh', 'ja', 'ko', 'tr', 'fa', 'ur', 'hi', 'bn', 'id', 'ms', 'th', 'nl', 'sv', 'no', 'da', 'fi', 'pl', 'cs', 'hu', 'ro', 'el', 'uk', 'vi', 'sr', 'hr', 'bg', 'sk', 'sl', 'lt', 'lv', 'et', 'tl', 'sw')`);
        await queryRunner.query(`CREATE TABLE "verse" ("id" SERIAL NOT NULL, "num" integer NOT NULL, "text" character varying NOT NULL, "textNormalized" character varying NOT NULL, "language" "public"."verse_language_enum" NOT NULL, "chapterId" integer, CONSTRAINT "PK_1bf192a2ee81fa999f9a75939e4" PRIMARY KEY ("id"))`);
