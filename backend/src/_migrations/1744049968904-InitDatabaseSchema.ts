...
export class InitDatabaseSchema1744049968904 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favorite" ("id" SERIAL NOT NULL, "profileEmail" text NOT NULL, "verseGroupId" integer NOT NULL, CONSTRAINT "UQ_d0bd95dd49ce11856904f737fb9" UNIQUE ("profileEmail", "verseGroupId"), CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "verse_group" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "startingVerseId" integer, CONSTRAINT "PK_ef2c6122160cd45ad4aa874900f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "favorite" ADD CONSTRAINT "FK_4280ca834f31e51ddc59343bb32" FOREIGN KEY ("verseGroupId") REFERENCES "verse_group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "verse_group" ADD CONSTRAINT "FK_02a82cc44ba88d7f19321f1530b" FOREIGN KEY ("startingVerseId") REFERENCES "verse"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "verse_group" DROP CONSTRAINT "FK_02a82cc44ba88d7f19321f1530b"`);
