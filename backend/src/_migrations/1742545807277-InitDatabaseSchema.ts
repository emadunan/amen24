...
export class InitDatabaseSchema1742545807277 implements MigrationInterface {
    name = 'InitDatabaseSchema1742545807277'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bookmark" ("id" SERIAL NOT NULL, "title" text NOT NULL, "profileEmail" text NOT NULL, "bookKey" text NOT NULL, "chapterNo" smallint NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b7fbf4a865ba38a590bb9239814" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_dbf9c339ebf18b8078346a475b" ON "bookmark" ("profileEmail", "bookKey", "chapterNo") `);
        ...
        await queryRunner.query(`CREATE TABLE "verse" ("bookKey" text NOT NULL, "chapterNo" smallint NOT NULL, "verseNo" smallint NOT NULL, "lang" text NOT NULL, "text" text NOT NULL, "textNormalized" text NOT NULL, "textDiacritized" text, CONSTRAINT "PK_da1ff4113c3fe9906c370a4f989" PRIMARY KEY ("bookKey", "chapterNo", "verseNo", "lang"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "FK_7cf2d66bf254d52dcef78841c4d" FOREIGN KEY ("bookKey", "chapterNo") REFERENCES "chapter"("bookKey","chapterNo") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" DROP CONSTRAINT "FK_7cf2d66bf254d52dcef78841c4d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_dbf9c339ebf18b8078346a475b"`);
