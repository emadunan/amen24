...
export class InitDatabase1739517026479 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."verse_language_enum" AS ENUM('en', 'ar', 'he', 'fr', 'de', 'es', 'it', 'pt', 'ru', 'zh', 'ja', 'ko', 'tr', 'fa', 'ur', 'hi', 'bn', 'id', 'ms', 'th', 'nl', 'sv', 'no', 'da', 'fi', 'pl', 'cs', 'hu', 'ro', 'el', 'uk', 'vi', 'sr', 'hr', 'bg', 'sk', 'sl', 'lt', 'lv', 'et', 'tl', 'sw')`);
