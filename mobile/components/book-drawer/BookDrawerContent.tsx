...
const BookDrawerContent: FC<Props> = ({ bookKey, bookId, bookLen, navigation }) => {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.chapterList}>
        ...
        {chapters.map((chapter) => {
          ...
          return <Pressable onPress={handlePress} key={chapter} style={({ pressed }) => [
            styles.chapterItem,
            pressed && styles.pressedItem,
          ]}><Text  style={styles.chapterText}>Chapter {chapter}</Text></Pressable>
        })}
      </View>
    </ScrollView>
  );
