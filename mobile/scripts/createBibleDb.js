    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 7:
          ...
          key = _c;
          if (!Object.prototype.hasOwnProperty.call(books_json_1.default, key))
            return [3 /*break*/, 12];
          return [
            4 /*yield*/,
            db.run("INSERT INTO books (key) VALUES (?)", [key]),
          ];
        case 8:
          response = _e.sent();
          bookId = response.lastID;
          bookMaxlength = books_json_1.default[key].len;
          chapters = Array.from({ length: bookMaxlength }, function (_, k) {
            return k + 1;
          });
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            db.run("INSERT INTO chapters (num, bookId) VALUES (?, ?)", [
              chapter,
              bookId,
            ]),
          ];
        ...
        case 15:
          ...
          return [
            4 /*yield*/,
            migrate(db, "../../content/original-scripts.txt", "versesNative"),
          ];
        case 16:
          _e.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            db.get("SELECT id from books where key = ?", [bookKey]),
          ];
        case 7:
          bookId = _a.sent().id;
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            db.get("SELECT id FROM chapters where bookId = ? AND num = ?", [
              bookId,
              chapterNum,
            ]),
          ];
