        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 12:
                    _i++;
                    return [3 /*break*/, 7];
                case 13: return [4 /*yield*/, migrate(db, "../../content/Holy-Bible---English---Free-Bible-Version---Source-Edition.VPL.txt", "versesEn")];
                case 14:
                    _e.sent();
                    return [4 /*yield*/, migrate(db, "../../content/Holy-Bible---Arabic---Arabic-Van-Dyck-Bible---Source-Edition.VPL.txt", "versesAr")];
                case 15:
                    _e.sent();
                    return [4 /*yield*/, migrate(db, "../../content/original-scripts.txt", "versesNative")];
                case 16:
                    _e.sent();
...
function migrate(db, filePath, bibleVersion) {
    return __awaiter(this, void 0, void 0, function () {
        var error_2, BibleData, lines, bookId, chapterId, _i, lines_1, line, result, bookKey, chapterNum, verseNum, verseText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    throw new Error("Database operation failed!");
                case 4: return [4 /*yield*/, (0, promises_1.readFile)(filePath, "utf-8")];
                case 5:
                    BibleData = _a.sent();
                ...
                case 6:
                    ...
                    if (!(chapterNum === "1" && verseNum === "1")) return [3 /*break*/, 8];
                ...
                case 7:
                    ...
                    _a.label = 8;
                case 8:
                    if (!(verseNum === "1")) return [3 /*break*/, 10];
                ...
                case 9:
                    ...
                    _a.label = 10;
                case 10: return [4 /*yield*/, db.run("INSERT INTO ".concat(bibleVersion, " (num, text, chapterId) VALUES (?, ?, ?)"), [verseNum, verseText, chapterId])];
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12:
