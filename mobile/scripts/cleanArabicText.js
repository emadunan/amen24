...
var normalizeArabicText = function (text) {
  ...
  text = text.replace(/[آأإٱةىؤئٮٯڤپچگ٠-٩]/g, function (char) {
        ...
        case 3:
          ...
          if (
            !!rows.some(function (row) {
              return row.name === "textNormalized";
            })
          )
            return [3 /*break*/, 5];
          return [
            4 /*yield*/,
            db.exec("ALTER TABLE versesAr ADD COLUMN textNormalized TEXT"),
          ];
        case 4:
          _a.sent();
          ...
          _a.label = 5;
        case 5:
          return [4 /*yield*/, db.all("SELECT * FROM versesAr")];
        case 6:
          allVerses = _a.sent();
          return [
            4 /*yield*/,
            db.prepare("UPDATE versesAr SET textNormalized = ? WHERE id = ?"),
          ];
        case 7:
          updateStmt = _a.sent();
