...
export class CreateNewBookmarkEntity1746344891651 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" DROP CONSTRAINT "UQ_dbbe441c08d730fe1a91ac17f16"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "UQ_dbbe441c08d730fe1a91ac17f16" UNIQUE ("profileEmail", "title", "verseId")`);
