...
export class AddLibraryBookEntities1749383089675 implements MigrationInterface {
    name = 'AddLibraryBookEntities1749383089675'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "library_book" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "author" character varying(255), "description" text, "category" character varying(100), "denomination" character varying(100), "church" character varying(150), "lang" character varying(20) NOT NULL DEFAULT 'en', "year" integer, "approvalStatus" text NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_6d1c6783237fc5912ca886cf8d8" UNIQUE ("slug"), CONSTRAINT "PK_49d9035ea8ba398acb83a01bd99" PRIMARY KEY ("id"))`);
