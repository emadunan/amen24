...
export class AddLibraryEntities1749287347941 implements MigrationInterface {
    name = 'AddLibraryEntities1749287347941'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "library_book" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "author" character varying(255), "description" text, "category" character varying(100), "lang" character varying(20) NOT NULL DEFAULT 'en', "year" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_49d9035ea8ba398acb83a01bd99" PRIMARY KEY ("id"))`);
