    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            db.run("INSERT INTO book (bookKey, slug) VALUES (?, ?)", [
              key,
              slug,
            ]),
          ];
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            db.run("INSERT INTO chapter (num, bookId) VALUES (?, ?)", [
              chapterNum,
              bookId,
            ]),
          ];
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            db.get("SELECT id FROM book WHERE bookKey = ?", [bookKey]),
          ];
        case 3:
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            db.get("SELECT id FROM chapter WHERE bookId = ? AND num = ?", [
              bookId,
              chapterNum,
            ]),
          ];
        case 5:
          chapterId =
            (_b = _c.sent()) === null || _b === void 0 ? void 0 : _b.id;
          _c.label = 6;
        case 6:
          return [
            4 /*yield*/,
            db.get("SELECT id FROM verse WHERE chapterId = ? AND num = ?", [
              chapterId,
              verseNum,
            ]),
          ];
        case 7:
          ...
          return [
            4 /*yield*/,
            db.run("INSERT INTO verse (num, chapterId) VALUES (?, ?)", [
              verseNum,
              chapterId,
            ]),
          ];
